...
Dies ist das deutschsprachige Portal der Nova-shell-Wiki.
Die Seite dient als kompakter Einstieg fuer deutschsprachige Nutzer, die schnell zu den wichtigsten Bereichen der Dokumentation springen wollen.
...
2. [NovaLanguage](./NovaLanguage.md)
3. [NovaRuntime](./NovaRuntime.md)
4. [ClassReference](./ClassReference.md)
